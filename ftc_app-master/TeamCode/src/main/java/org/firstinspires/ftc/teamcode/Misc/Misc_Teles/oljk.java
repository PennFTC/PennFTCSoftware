...
@TeleOp(name = "KeatonHelp")
//@Disabled
public class oljk extends OpMode {
    ...
    public void init() {
        ...
        DcMotors[backright].setDirection(DcMotorSimple.Direction.REVERSE);
        DcMotors[frontright].setDirection(DcMotorSimple.Direction.REVERSE);
    ...
    public void loop() {
        ...
        final double v3 = gamepad1.right_stick_y;
        final double v4 = gamepad1.right_stick_y;
        ...
        DcMotors[arm].setPower(.10 * gamepad2.left_stick_y);
