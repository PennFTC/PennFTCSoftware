...
public class HardwareBravoBot { // This class file contains all the hardware that is on our outreach bot the bravobot
    ...
    public void init(HardwareMap ahwMap) {
        // Motor stuffs
        backleft = ahwMap.dcMotor.get("0");
        frontleft = ahwMap.dcMotor.get("1");
        backright = ahwMap.dcMotor.get("2");
        frontright = ahwMap.dcMotor.get("3");
        conveyor = ahwMap.dcMotor.get("4");
        plow = ahwMap.dcMotor.get("5");
        leftshooter = ahwMap.dcMotor.get("6");
        rightshooter = ahwMap.dcMotor.get("7");
