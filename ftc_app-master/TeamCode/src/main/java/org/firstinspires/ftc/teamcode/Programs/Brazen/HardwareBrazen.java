...
public class HardwareBrazen {
    ...
    public void init(HardwareMap hwMap) {
        leftdrive = hwMap.dcMotor.get("leftdrive"); rightdrive = hwMap.dcMotor.get("rightdrive");
        lift = hwMap.dcMotor.get("lift");
        leftclaw = hwMap.servo.get("leftclaw");  rightclaw = hwMap.servo.get("rightclaw");
        leftdrive.setPower(0);  rightdrive.setPower(0); lift.setPower(0);
