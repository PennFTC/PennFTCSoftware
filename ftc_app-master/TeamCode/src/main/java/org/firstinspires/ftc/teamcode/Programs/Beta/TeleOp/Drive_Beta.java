...
public class Drive_Beta extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.right_bumper) {
            ...
            robot.leftbottomclaw.setPosition(0);   robot.rightbottomclaw.setPosition(1);}
        if (gamepad2.left_bumper) {
            robot.lefttopclaw.setPosition(1);       robot.righttopclaw.setPosition(0);
        } else {
            robot.lefttopclaw.setPosition(0);       robot.righttopclaw.setPosition(1);  }}}