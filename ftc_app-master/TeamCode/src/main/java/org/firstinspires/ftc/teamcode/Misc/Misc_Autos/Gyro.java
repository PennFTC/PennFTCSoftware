...
@Autonomous(name="gryo", group="Pushbot")
...
public class Gyro extends LinearOpMode {
    ...
    ModernRoboticsI2cGyro modernRoboticsI2cGyro;                   // Additional Gyro device
    ...
    public void runOpMode() {
        ...
        gyroTurn( TURN_SPEED,  10.0);         // Turn  CW  to  45 Degrees
        gyroHold( TURN_SPEED,  10.0, 0.5);    // Hold  45 Deg heading for a 1/2 second
