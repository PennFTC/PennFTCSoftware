...
/////////////////////////////////////// SHANKBOT COMPONENTS \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
public class TRy // this is the name that we can import into other programs.
{
    ///////////////// MOTORS \\\\\\\\\\\\\\\
    public DcMotor leftdrive , rightdrive, slide, leftwheel, rightwheel, arm = null;
    public Servo thwack, rotate, extend = null;
